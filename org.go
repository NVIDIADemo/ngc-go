...
func (r *OrgService) List(ctx context.Context, query OrgListParams, opts ...option.RequestOption) (res *pagination.PageNumberOrganizations[OrgListResponse], err error) {
...
// List all organizations of the user
func (r *OrgService) ListAutoPaging(ctx context.Context, query OrgListParams, opts ...option.RequestOption) *pagination.PageNumberOrganizationsAutoPager[OrgListResponse] {
...
// orgListResponseJSON contains the JSON metadata for the struct [OrgListResponse]
type orgListResponseJSON struct {
	ID                                      apijson.Field
	AlternateContact                        apijson.Field
	BillingAccountID                        apijson.Field
	CanAddOn                                apijson.Field
...
func (r orgListResponseJSON) RawJSON() string {
	return r.raw
}
...
// orgListResponseAlternateContactJSON contains the JSON metadata for the struct
// [OrgListResponseAlternateContact]
type orgListResponseAlternateContactJSON struct {
	Email       apijson.Field
	FullName    apijson.Field
	raw         string
	ExtraFields map[string]apijson.Field
...
func (r orgListResponseAlternateContactJSON) RawJSON() string {
	return r.raw
}
...
// orgListResponseInfinityManagerSettingsJSON contains the JSON metadata for the
// struct [OrgListResponseInfinityManagerSettings]
type orgListResponseInfinityManagerSettingsJSON struct {
	InfinityManagerEnabled            apijson.Field
	InfinityManagerEnableTeamOverride apijson.Field
	raw                               string
	ExtraFields                       map[string]apijson.Field
...
func (r orgListResponseInfinityManagerSettingsJSON) RawJSON() string {
	return r.raw
}
...
// orgListResponseOrgOwnerJSON contains the JSON metadata for the struct
// [OrgListResponseOrgOwner]
type orgListResponseOrgOwnerJSON struct {
	Email         apijson.Field
	FullName      apijson.Field
	LastLoginDate apijson.Field
	raw           string
...
func (r orgListResponseOrgOwnerJSON) RawJSON() string {
	return r.raw
}
...
// orgListResponseProductEnablementJSON contains the JSON metadata for the struct
// [OrgListResponseProductEnablement]
type orgListResponseProductEnablementJSON struct {
	ProductName    apijson.Field
	Type           apijson.Field
	ExpirationDate apijson.Field
	PoDetails      apijson.Field
...
func (r orgListResponseProductEnablementJSON) RawJSON() string {
	return r.raw
}
...
func (r OrgListResponseProductEnablementsType) IsKnown() bool {
	switch r {
	case OrgListResponseProductEnablementsTypeNgcAdminEval, OrgListResponseProductEnablementsTypeNgcAdminNfr, OrgListResponseProductEnablementsTypeNgcAdminCommercial, OrgListResponseProductEnablementsTypeEmsEval, OrgListResponseProductEnablementsTypeEmsNfr, OrgListResponseProductEnablementsTypeEmsCommercial, OrgListResponseProductEnablementsTypeNgcAdminDeveloper:
		return true
	}
	return false
}
...
// orgListResponseProductEnablementsPoDetailJSON contains the JSON metadata for the
// struct [OrgListResponseProductEnablementsPoDetail]
type orgListResponseProductEnablementsPoDetailJSON struct {
	EntitlementID apijson.Field
	PkID          apijson.Field
	raw           string
	ExtraFields   map[string]apijson.Field
...
func (r orgListResponseProductEnablementsPoDetailJSON) RawJSON() string {
	return r.raw
}
...
// orgListResponseProductSubscriptionJSON contains the JSON metadata for the struct
// [OrgListResponseProductSubscription]
type orgListResponseProductSubscriptionJSON struct {
	ProductName        apijson.Field
	ID                 apijson.Field
	EmsEntitlementType apijson.Field
	ExpirationDate     apijson.Field
...
func (r orgListResponseProductSubscriptionJSON) RawJSON() string {
	return r.raw
}
...
func (r OrgListResponseProductSubscriptionsEmsEntitlementType) IsKnown() bool {
	switch r {
	case OrgListResponseProductSubscriptionsEmsEntitlementTypeEmsEval, OrgListResponseProductSubscriptionsEmsEntitlementTypeEmsNfr, OrgListResponseProductSubscriptionsEmsEntitlementTypeEmsCommerical, OrgListResponseProductSubscriptionsEmsEntitlementTypeEmsCommercial:
		return true
	}
	return false
}
...
func (r OrgListResponseProductSubscriptionsType) IsKnown() bool {
	switch r {
	case OrgListResponseProductSubscriptionsTypeNgcAdminEval, OrgListResponseProductSubscriptionsTypeNgcAdminNfr, OrgListResponseProductSubscriptionsTypeNgcAdminCommercial:
		return true
	}
	return false
}
...
// orgListResponseRepoScanSettingsJSON contains the JSON metadata for the struct
// [OrgListResponseRepoScanSettings]
type orgListResponseRepoScanSettingsJSON struct {
	RepoScanAllowOverride       apijson.Field
	RepoScanByDefault           apijson.Field
	RepoScanEnabled             apijson.Field
	RepoScanEnableNotifications apijson.Field
...
func (r orgListResponseRepoScanSettingsJSON) RawJSON() string {
	return r.raw
}
...
func (r OrgListResponseType) IsKnown() bool {
	switch r {
	case OrgListResponseTypeUnknown, OrgListResponseTypeCloud, OrgListResponseTypeEnterprise, OrgListResponseTypeIndividual:
		return true
	}
	return false
}
...
// orgListResponseUsersInfoJSON contains the JSON metadata for the struct
// [OrgListResponseUsersInfo]
type orgListResponseUsersInfoJSON struct {
	TotalUsers  apijson.Field
	raw         string
	ExtraFields map[string]apijson.Field
}
...
func (r orgListResponseUsersInfoJSON) RawJSON() string {
	return r.raw
}
