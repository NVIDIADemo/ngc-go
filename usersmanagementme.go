...
// What am I?
func (r *UsersManagementMeService) Get(ctx context.Context, query UsersManagementMeGetParams, opts ...option.RequestOption) (res *shared.User, err error) {
...
func (r *UsersManagementMeService) Update(ctx context.Context, body UsersManagementMeUpdateParams, opts ...option.RequestOption) (res *shared.User, err error) {
	opts = append(r.Options[:], opts...)
	path := "v2/users/me"
