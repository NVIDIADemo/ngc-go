...
// privileges required)
func (r *V2AdminEntitlementService) GetAll(ctx context.Context, query V2AdminEntitlementGetAllParams, opts ...option.RequestOption) (res *http.Response, err error) {
...
// URLQuery serializes [V2AdminEntitlementGetAllParams]'s query parameters as
// `url.Values`.
