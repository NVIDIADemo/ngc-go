...
// privileges required)
func (r *V2AdminOrgEntitlementService) GetAll(ctx context.Context, orgName string, query V2AdminOrgEntitlementGetAllParams, opts ...option.RequestOption) (res *http.Response, err error) {
...
// URLQuery serializes [V2AdminOrgEntitlementGetAllParams]'s query parameters as
// `url.Values`.
