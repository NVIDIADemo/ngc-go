...
func (r *SuperAdminUserOrgTeamUserService) New(ctx context.Context, orgName string, teamName string, params SuperAdminUserOrgTeamUserNewParams, opts ...option.RequestOption) (res *shared.User, err error) {
