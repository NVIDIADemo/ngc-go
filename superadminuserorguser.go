...
func (r *SuperAdminUserOrgUserService) New(ctx context.Context, orgName string, params SuperAdminUserOrgUserNewParams, opts ...option.RequestOption) (res *shared.User, err error) {
